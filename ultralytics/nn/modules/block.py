...
def window_partition(x, window_size):
    """
    Chops a [B, C, H, W] tensor into non-overlapping windows.
    Returns: [B * num_windows, window_size * window_size, C]
    """
    B, C, H, W = x.shape
    # Reshape to isolate the windows
    x = x.view(B, C, H // window_size, window_size, W // window_size, window_size)
    # Permute to group window dimensions together, then flatten the window spatial grid
...
def window_reverse(windows, window_size, H, W):
    """
    Stitches the windows back together into a [B, C, H, W] tensor.
    """
